...
<h3>File 1: Chat_Model_LLM.ipynb</h3>
<p>
This notebook explains how <strong>chat models work internally</strong> using
LangChain and Google Gemini.
</p>

<ul>
    <li>Regular LLMs vs Chat LLMs</li>
    <li>System, Human, and AI messages</li>
    <li>Conversation flow and context</li>
    <li>Why chat models feel more natural</li>
</ul>

<hr>

<h3>File 2: main.py (Streamlit Chat App)</h3>
<p>
...
<p>
Watching the video is recommended for beginners.
</p>
</div>
...
<div class="section">
<h2>🎯 Why This Repository Is Valuable</h2>

<ul>
    <li>Clear transition from Regular LLMs to Chat LLMs</li>
    <li>Conceptual + practical learning approach</li>
    <li>Industry-aligned project structure</li>
    <li>Secure and scalable practices</li>
</ul>
</div>
